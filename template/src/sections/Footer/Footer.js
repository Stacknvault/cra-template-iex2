        ...
        `}>
            ...
            `}>
                <div className="footerDiv">
                    ...
                    <div className="info">
                        <span className="value">{ffmap`company.companyUrl` && (ffmap`company.companyUrl`).replace('http://', '').replace('https://', '')} | {ffmap`company.companyMailInfo`}</span>
                    </div>
                </div>
            </div>
        </div>
